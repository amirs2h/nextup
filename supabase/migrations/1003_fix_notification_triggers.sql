-- ============================================================
-- MIGRATION 1003: Fix notification triggers
-- ============================================================
-- 1. notify_followers_on_comment: skip replies, add title to data
-- 2. notify_on_reply: add title to data
-- 3. notify_on_comment_like: add title to data
-- 4. notify_on_follow: add avatar_url to data
-- ============================================================

-- 1. Fix notify_followers_on_comment: skip replies + add title
...
DECLARE
  ...
  content_title TEXT;
BEGIN
  -- Skip replies (only notify for top-level comments)
...
-- 2. Fix notify_on_reply: add title to data
...
-- 3. Fix notify_on_comment_like: add title to data
...
BEGIN
  SELECT user_id, content, title, tmdb_id, media_type, season_number, episode_number
  INTO comment_owner_id, comment_content, comment_title, comment_tmdb_id, comment_media_type, comment_season, comment_episode
...
-- 4. Fix notify_on_follow: add avatar_url to data
